...
pub fn string_record_deserializer<'de>(
...
pub fn deserialize_string_record<'de, D: Deserialize<'de>>(
    ...
    let mut deser = string_record_deserializer(record, headers);
...
pub fn byte_record_deserializer<'de>(
...
pub fn deserialize_byte_record<'de, D: Deserialize<'de>>(
    ...
    let mut deser = byte_record_deserializer(record, headers);
